...
const interests = [
	new Interest(
		...
		'การเขียนโค้ด, การเพิ่มประสิทธิภาพและเคล็ดลับในการดำเนินชีวิต, การอ่าน'
	),
	new Interest('วิ่ง', 'วิ่ง 5 กิโลเมตร 5 วันต่อสัปดาห์, วิ่งไปที่ยาวที่สุดคือ 11 กิโลเมตร'),
	new Interest('ดนตรี', 'ฉันเป็นคนรักดนตรี เมื่อฉันมีเวลาว่างฉันจะเล่นกีตาร์หรือฟังเพลง'),
	new Interest(
		'สัตว์เลี้ยง',
		'ฉันมีสุนัข 1 ตัวและแมว 2 ตัว ฉันจะเล่นกับพวกเขาเมื่อรู้สึกเหงาหรือเบื่อ'
	)
];
...
const langs = [
	...
	new Language(
		'English',
		'เชี่ยวชาญ',
		'ข้าพเข้ามีทักษะการอ่านและการฟังที่เชี่ยวชาญ และสามารถพูดได้อย่างราบรื่นด้วยสำเนียงที่เกือบจะคล่อง ทักษะการเขียนของฉันอยู่ในระดับปานกลาง'
	)
];
