...
const interests = [
	...
	new Interest(
		'ดนตรี',
		'กระผมเป็นคนชอบฟังดนตรี เมื่อกระผมมีเวลาว่าง มักจะชอบฟังเพลง หรือเล่นกีตาร์และค่อยฝึกเพือมั่นพัฒนาการเล่นอยู่เสมอ'
	),
	new Interest(
		'สัตว์เลี้ยง',
...
const langs = [
	...
	new Language(
		'English',
		'เชี่ยวชาญ',
		'กระผมมีทักษะการอ่านและการฟังที่ดี และพูดได้อย่างราบรื่น โดยทักษะการเขียนของกระผมอยู่ในระดับปานกลางค่อนดี'
	)
];
