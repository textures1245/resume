...
const objective =
	'ผมกำลังเตรียมตัวในการทำสหกิจศึกษาด้านวิศวกรรมซอฟต์แวร์ ซึ่งเป็นโอกาสที่ดีในการประยุกต์ใช้ทักษะทางเทคโนโลยีของผมในโครงการที่ทันสมัย ผมเป็นนักศึกษาคอมพิวเตอร์ที่มีความรู้และความเชี่ยวชาญทางด้านการเขียนโปรแกรม มีประสบการณ์ในการใช้เครื่องมือพัฒนาและฐานข้อมูล ผมพร้อมที่จะมีส่วนร่วมในทีมและเป็นส่วนหนึ่งของโครงการนวัตกรรมที่น่าตื่นเต้น การเข้าร่วมองค์กรนี้จะช่วยในการพัฒนาผมเป็นวิศวกรซอฟต์แวร์และมีส่วนร่วมในโครงการนวัตกรรมอย่างต่อเนื่องและเติบโตตามความสามารถของผมไปข้างหน้าครับ';

const summary =
	'ผมเป็นคนที่มีความหลงใหลในการพัฒนาเว็บและพื้นฐานทักษะทางเทคนิค ผมมีความเชี่ยวชาญในการใช้ภาษาและเครื่องมือการเขียนโปรแกรม และครอบคลุมการทำงานในด้านต่างๆ อีกทั้งยังมีความสามารถในการทำงานเป็นทีมได้ดี ผมชอบให้คำปรึกษาและสรุปการดำเนินงานของกลุ่ม ผมเชื่อในความชัดเจนของเป้าหมายและวัตถุประสงค์ และผมเคารพเหตุผลของสมาชิกในทีมและเป็นกำลังสำคัญในการสื่อสาร ผมยังเป็นที่ปรึกษาและผู้ช่วยสอนให้กับรุ่นน้องหลายคนและรับผิดชอบส่วนของการเป็นหัวหน้า TA (Team Assistant) ในโครงการ CompCamp ผมมุ่งมั่นที่จะใช้ความรู้ของผมในโครงการจริงเพื่อรับประสบการณ์และมีส่วนร่วมในการพัฒนานวัตกรรมอย่างเต็มรูปแบบ';
const certificates = [
	new Certificate(
